...
CREATE TABLE `reservation` (
  ...
  CONSTRAINT `reservation_chk_1` CHECK ((`reservation_status` between 0 and 3))
...
INSERT INTO `reservation` VALUES (1,'2025-02-05T09:35:04.087Z','dfg45',1,'Cuple-Style-Table',3);
